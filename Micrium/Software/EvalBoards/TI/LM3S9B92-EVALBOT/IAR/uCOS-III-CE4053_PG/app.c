...
static  void  AppTaskStart (void  *p_arg)
{
   ...
   // OSMutexCreate((OS_MUTEX *)&MutexThree, (CPU_CHAR *)3, (OS_ERR *)&err);
    ...
    OSTaskCreate((OS_TCB     *)&AppTaskRepeatOneTCB,
                 (CPU_CHAR   *)"Repeat Task One",
                 (OS_TASK_PTR ) AppTaskRepeatOne,
                 (void       *) 0,
                 (OS_PRIO     ) APP_TASK_REPEAT_ONE_PRIO,
                 (OS_TICK     ) 0u,
                 (CPU_STK    *)&AppTaskRepeatOneStk[0],
                 (CPU_STK_SIZE) APP_TASK_ONE_STK_SIZE / 10u,
                 (CPU_STK_SIZE) APP_TASK_ONE_STK_SIZE,
                 (OS_MSG_QTY  ) 0u,
                 (OS_TICK     ) 0u,
                 ...
                 (OS_OPT      )(OS_OPT_TASK_STK_CHK | OS_OPT_TASK_STK_CLR),
                 (OS_ERR     *)&err);
    OSTaskCreate((OS_TCB     *)&AppTaskRepeatTwoTCB,
                 (CPU_CHAR   *)"Repeat Task Two",
                 (OS_TASK_PTR ) AppTaskRepeatTwo,
                 (void       *) 0,
                 (OS_PRIO     ) APP_TASK_REPEAT_TWO_PRIO,
                 (OS_TICK     ) 0u,
                 (CPU_STK    *)&AppTaskRepeatTwoStk[0],
                 (CPU_STK_SIZE) APP_TASK_ONE_STK_SIZE / 10u,
                 (CPU_STK_SIZE) APP_TASK_ONE_STK_SIZE,
                 (OS_MSG_QTY  ) 0u,
                 (OS_TICK     ) 0u,
                 ...
                 (OS_OPT      )(OS_OPT_TASK_STK_CHK | OS_OPT_TASK_STK_CLR),
                 (OS_ERR     *)&err);
    OSTaskCreate((OS_TCB    *)&AppTaskRepeatThreeTCB,
                 (CPU_CHAR   *)"Repeat Task Three",
                 (OS_TASK_PTR ) AppTaskRepeatThree,
                 (void       *) 0,
                 (OS_PRIO     ) APP_TASK_REPEAT_THREE_PRIO,
                 (OS_TICK     ) 0u,
                 (CPU_STK    *)&AppTaskRepeatThreeStk[0],
                 (CPU_STK_SIZE) APP_TASK_ONE_STK_SIZE / 10u,
                 (CPU_STK_SIZE) APP_TASK_ONE_STK_SIZE,
                 (OS_MSG_QTY  ) 0u,
                 (OS_TICK     ) 0u,
