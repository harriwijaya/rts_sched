...
#define OS_CFG_EDF_PRIO                 5u   /* Defines at what priority the TCB from EDF List will be treated by scheduler, */
                                             /* this hence the lowest priority of highest-system-tasks-priority */
